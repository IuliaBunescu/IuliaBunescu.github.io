...
<div class="pub-grid">
	<article class="pub-card">
		...
		<ul class="publication-card__highlights">
			<li>Distils industry reports into digestible opportunity areas.</li>
			<li>Outlines go-to-market realities for early-stage biotech startups.</li>
	...
	<article class="pub-card">
		...
		<ul class="publication-card__highlights">
			<li>Frames neurotechnology advances for product teams and investors.</li>
			<li>Showcases exemplar startups and their differentiating tech stacks.</li>
	...
	<article class="pub-card">
		...
		<ul class="publication-card__highlights">
			<li>Translates R&D breakthroughs into product implications for foodtech.</li>
			<li>Connects consumer sentiment data with adoption hurdles.</li>
